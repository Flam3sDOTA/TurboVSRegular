...
Turbo vs Regular is a Dota 2 custom game mode with asymmetric rulesets where the Radiant uses Turbo rules and the Dire uses regular rules. Both teams play on the same map with the same objectives, but the difference in game rules creates a completely different match experience for each side.

<h2>Team Radiant/Team Turbo</h2>

*   All experience gain doubled.
*   All Creep bounties doubled
*   Hand of Midas gold doubled.
*   Bounty gold doubled.
*   No gold lost on death.
*   Ancient do not regenerate health.
*   All Madstone cap timings happen earlier(applies to Dire too) & Radiant gain double madstones per cleared camp.
*   Weaker towers
*   Mega creeps have twice the HP and damage
*   Turbo Couriers
...
*   Town Portal Scrolls and Boots of Travel have halved cooldowns.
